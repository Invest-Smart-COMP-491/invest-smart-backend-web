...
urlpatterns = [
    ...
    path("commentLikes/<slug:comment_id>", views.CommentsLikesApiView.as_view(), name="comments_likes"),
    path("favAssets", views.CurrentUserFavouriteAssetsApiView.as_view(), name="favourite_assets"),
    path("favCategories", views.CurrentUserFavouriteCategoryApiView.as_view(), name="favourite_categories"),
]